...
<li data-id="${item.doc._id}"${item.doc.completed ? ' class="completed"' : ''}>
	<input class="toggle" type="checkbox" ${item.doc.completed ? 'checked' : ''}>
	<label>${escapeForHTML(item.doc.title)}</label>
